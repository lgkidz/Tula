...
public class EditStuffDetailsActivity extends AppCompatActivity {
    ...
    private String ingreCate;
    private String ingreQuan;
    ...
    public void init(){
        ...
        ingreName = intentStartedThis.getExtras().getString("ingreName");
        ingreCate = intentStartedThis.getExtras().getString("ingreCate");
        ingreQuan = intentStartedThis.getExtras().getString("ingreQuan");
        ingreUnit = intentStartedThis.getExtras().getString("ingreUnit");
        ingreExpDate = intentStartedThis.getExtras().getString("ingreExpDate");
        ingreNoti = intentStartedThis.getExtras().getString("ingreNoti");
        ...
        unit_spinner.setSelection(spinnerPosition);
        noti_switch.setChecked(Boolean.parseBoolean(ingreNoti));
    ...
    public void saveStuff(){
        if(!et_quan.getText().toString().equals("")){
            new AlertDialog.Builder(this).setTitle("Chỉnh sửa nguyên liệu")
                    ...
                    .setPositiveButton("Oke", new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialog, int which) {
                            ...
                            for(Map<String,String> m : stuffs){
                                if(m.get("iName").equals(ingreName) && m.get("iQuan").equals(ingreQuan) && m.get("iExpDate").equals(ingreExpDate) && m.get("iNoti").equals(ingreNoti)){
                                    stuffs.remove(m);
                                    break;
                                }
                            }
                            ...
                            editor.apply();
                            Intent backToTulaIntent = new Intent(EditStuffDetailsActivity.this,MainActivity.class);
